...
const Hero = () => {
  ...
  return (
    <section className='relative w-full h-screen mx-auto flex flex-col justify-center text-center'>
      ...
      {!isMobile ? (<ComputersCanvas />) 
        : <p className={`${styles.sectionSubText} text-white font-bold mt-40`}>Scroll down or click on the icon below<br /> to get to know me better!</p>
      }
